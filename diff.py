...
OUTPUT_REGEXP = re.compile(r'.*/CRISPResso2_tests/cli_integration_tests/CRISPRessoBatch_on_FANC')
...
def substitute_line(line):
    ...
    line = OUTPUT_REGEXP.sub('CRISPResso2_tests/cli_integration_tests/CRISPRessoBatch_on_FANC', line)
    return line
